...
import {Input, Radio, RadioGroup, Skeleton, Textarea} from "@nextui-org/react";
            ...
            <div className="w-1/2 flex gap-7.5">
                ...
                <div className="w-4/5 ">
                    <div className="w-[444px] h-[444px] bg-zinc-50 relative select-none">
                        <button onClick={prevPhoto} disabled={imagePreviews.length === 0 || mainImage === 0}
                                className={`absolute h-[40px] m-auto cursor-pointer bottom-0 left-0 top-0 rounded-2xl transition hover:scale-125`}>
                            <HiChevronLeft size="2rem" color={"white"}/>
                        </button>
                        <button onClick={nextPhoto}
                                disabled={imagePreviews.length === 0 || mainImage === imagePreviews.length - 1}
                                className={`absolute h-[40px] m-auto cursor-pointer bottom-0 right-0 top-0 rounded-2xl transition hover:scale-125`}>
